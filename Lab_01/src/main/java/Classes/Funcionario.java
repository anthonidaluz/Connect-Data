...
public class Funcionario {
    ...
    private int cnh;
    private LocalDate data_contrtado;
    ...
    public Funcionario(int idFuncionário, String nome, String cpf, String email, char genero, String telefone, String endereco, String bairro, String cidade, String cep, String nacionalidade, int cnh, LocalDate data_contrtado, String periodo, String nome_empresa, int idDepartamento, String foto, int idRelatorios, int MetaCumprida) {
        this.idFuncionário = idFuncionário;
        this.nome = nome;
        this.cpf = cpf;
        this.email = email;
        ...
        this.cnh = cnh;
        this.data_contrtado = data_contrtado;
    ...
    public LocalDate getData_contrtado() {
        return data_contrtado;
    }

    public void setData_contrtado(LocalDate data_contrtado) {
        this.data_contrtado = data_contrtado;
    }
